...
serve(async (req) => {
  ...
  try {
    ...
    const staticRoutes: SitemapUrl[] = [
      ...
      { loc: '/oceanic', priority: 0.7, changefreq: 'weekly' },
      ...
      { loc: '/brand', priority: 0.5, changefreq: 'monthly' },
      { loc: '/research-submission', priority: 0.5, changefreq: 'monthly' },
      { loc: '/partnership', priority: 0.5, changefreq: 'monthly' },
      { loc: '/support-research', priority: 0.5, changefreq: 'monthly' },
