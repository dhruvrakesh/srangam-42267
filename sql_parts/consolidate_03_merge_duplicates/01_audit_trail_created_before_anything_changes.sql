-- 01_audit_trail_created_before_anything_changes.sql  ·  split from consolidate_03_merge_duplicates.sql
-- This part contains 3 statements. The editor shows only the LAST
