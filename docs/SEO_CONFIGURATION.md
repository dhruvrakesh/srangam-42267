...
<meta name="twitter:image" content="https://srangam-db.lovable.app/brand/og-image.png" />
```
...
- HTML (for humans): `https://srangam-db.lovable.app/sitemap`
...
- [x] Canonical URL standardized to `srangam-db.lovable.app`
...
### SEO Audit Checklist
1. Verify all canonical URLs use `srangam-db.lovable.app`
