...
export default function AshokaKandaharEdicts() {
  return (
    <ArticlePage
      title="Bharat's Ancient Heritage: Beyond Ashoka's Legacy"
      dek="From Indus Valley scripts to multilingual edicts: India's unbroken civilizational journey across millennia."
      content={content}
      tags={["Ancient India", "Indus Valley", "Vedic Culture", "Ashoka", "Epigraphy"]}
      icon={IconScript}
      readTime={18}
