  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Vedic Preservation Series: 2-Part Featured Section */}
        <div className="mb-12 bg-gradient-to-r from-turmeric/10 to-sandalwood/10 rounded-lg p-8 border-2 border-turmeric/20">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="text-2xl font-semibold">Vedic Preservation Series</h3>
              <p className="text-sm text-muted-foreground">Two-part exploration: Technology & Lineages</p>
            </div>
          </div>
          
          <div className="grid md:grid-cols-2 gap-6 mt-6">
            {/* Part 1: Śarīra and Ātman */}
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center justify-between mb-2">
                  <Badge variant="outline">Part 1: Technology</Badge>
                  <span className="text-xs text-muted-foreground">38 min read</span>
                </div>
                <CardTitle className="text-lg">Śarīra and Ātman</CardTitle>
                <CardDescription>The Preservation of the Vedas through the Anukramaṇīs and Sāyaṇāchārya</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm mb-4">
                  How did oral texts survive millennia without corruption? The Anukramaṇīs provided the <em>śarīra</em> (body)—indexing each mantra by ṛṣi, devatā, and chandas. Sāyaṇāchārya's 14th-century commentary provided the <em>ātman</em> (soul)—preserving meaning during Vijayanagara's manuscript renaissance.
                </p>
                <Link to="/sarira-atman-vedic-preservation" className="text-primary hover:underline text-sm font-medium">
                  Read Part 1: Technology →
                </Link>
              </CardContent>
            </Card>

            {/* Part 2: Ṛṣi Genealogies */}
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center justify-between mb-2">
                  <Badge variant="outline">Part 2: Lineages</Badge>
                  <span className="text-xs text-muted-foreground">42 min read</span>
                </div>
                <CardTitle className="text-lg">Ṛṣi Genealogies in Vedic Tradition</CardTitle>
                <CardDescription>Bhṛgu, Āṅgiras, and Kāśyapa Lineages</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm mb-4">
                  A source-led exploration of the three venerable ṛṣi families who composed the Ṛgveda: their hymn attributions (Maṇḍalas II, IV, VI, IX), intra-family connections, and thematic legacies (fire cult, Indra worship, Soma liturgy) as recorded in the Anukramaṇī tradition.
                </p>
                <Link to="/rishi-genealogies-vedic-tradition" className="text-primary hover:underline text-sm font-medium">
                  Read Part 2: Lineages →
                </Link>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="mt-6 p-4 bg-background/50 rounded-lg border border-turmeric/10">
            <p className="text-sm">
              <strong>Integrated Series:</strong> Part 1 examines <em>how</em> the Anukramaṇīs functioned as preservation technology (metrical checksums, multi-factor authentication). Part 2 explores <em>who</em> the ṛṣi families were and what they composed. Together: 80 minutes of scholarly analysis demonstrating both the <strong>technical mechanisms</strong> and <strong>human transmission chains</strong> that preserved the Vedic corpus across 3,000+ years.
            </p>
          </div>
        </div>
