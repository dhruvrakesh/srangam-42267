...
export default function Home() {
  ...
  return (
    <div className="bg-background relative overflow-hidden">
      {/* Dharmic Background Patterns */}
      <div className="fixed inset-0 mandala-bg opacity-5 pointer-events-none" />
      <div className="fixed top-0 right-0 w-96 h-96 chakra-pattern rounded-full chakra-spin opacity-10 pointer-events-none" />
      ...
      <section className="relative min-h-screen">
        ...
        {/* Floating Lotus and Sacred Symbols */}
        <div className="absolute top-20 left-10 lotus-bloom opacity-30">
          <IconLotus size={48} className="text-lotus-pink" />
        </div>
        <div className="absolute top-32 right-16 om-pulse opacity-40">
          <IconOm size={40} className="text-saffron" />
        </div>
        <div className="absolute bottom-32 left-20 chakra-spin opacity-25">
          <IconDharmaChakra size={56} className="text-turmeric" />
        </div>
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Button asChild size="lg" className="bg-saffron hover:bg-saffron-light text-charcoal-om border-0 shadow-2xl hover:shadow-saffron/25 transition-all duration-300 hover:scale-105 lotus-bloom">
                <Link to="/themes/ancient-india">
                  <IconSarnathLion size={20} className="mr-2" />
                  यात्रा प्रारम्भ | Begin Journey
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="border-2 border-sandalwood text-sandalwood hover:bg-sandalwood hover:text-charcoal-om shadow-2xl hover:shadow-sandalwood/25 transition-all duration-300 hover:scale-105 backdrop-blur-sm bg-indigo-dharma/20">
                <Link to="/about">
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 om-pulse">
          <div className="w-6 h-10 border-2 border-turmeric/60 rounded-full flex justify-center backdrop-blur-sm bg-indigo-dharma/20 shadow-lg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {featuredArticles.map((article, index) => (
              <div key={article.id} className="lotus-bloom" style={{ animationDelay: `${index * 0.2}s` }}>
          ...
          <div className="text-center">
            <Button asChild variant="outline" size="lg" className="border-2 border-saffron text-saffron hover:bg-saffron hover:text-charcoal-om transition-all duration-300 hover:scale-105">
              <Link to="/field-notes">
                <IconLotus size={20} className="mr-2" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12">
            <div className="flex justify-center gap-4 mb-6">
              <IconDharmaChakra size={56} className="text-turmeric chakra-spin" />
            </div>
            <h2 className="font-serif text-3xl font-bold text-foreground mb-4">
            ...
            {themes.slice(0, 3).map((theme, index) => {
              ...
              return (
                <Link
                  key={theme.path}
                  to={theme.path}
                  className={`group block p-8 bg-card rounded-lg border border-border hover:shadow-xl transition-all duration-300 hover:border-primary/50 relative overflow-hidden lotus-bloom ${theme.bgPattern || ''}`}
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center justify-center mb-6">
                      <div className={`${theme.color} om-pulse`}>
      ...
      <section className="py-16 bg-lotus-pink/10 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Link to="/field-notes" className="group text-center p-8 bg-card rounded-lg border border-border hover:shadow-xl transition-all duration-300 lotus-bloom relative overflow-hidden">
              <div className="absolute inset-0 mandala-bg opacity-5" />
              <IconOm size={56} className="mx-auto text-saffron mb-6 group-hover:scale-110 transition-transform om-pulse" />
            ...
            <Link to="/maps-data" className="group text-center p-8 bg-card rounded-lg border border-border hover:shadow-xl transition-all duration-300 lotus-bloom relative overflow-hidden">
              <div className="absolute inset-0 chakra-pattern opacity-5" />
              <IconDharmaChakra size={56} className="mx-auto text-turmeric mb-6 group-hover:scale-110 transition-transform chakra-spin" />
            ...
            <Link to="/about" className="group text-center p-8 bg-card rounded-lg border border-border hover:shadow-xl transition-all duration-300 lotus-bloom relative overflow-hidden">
              <div className="absolute inset-0 dharma-scroll opacity-5" />
              <IconLotus size={56} className="mx-auto text-lotus-pink mb-6 group-hover:scale-110 transition-transform lotus-bloom" />
